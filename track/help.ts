...
- \`story\` — **Story** the session serves, found-or-created by name under the project; only if evident. A story bound for Cockpit needs a brief AND at least one body paragraph on the story page itself — the filer skips anything less.
