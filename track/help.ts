...
- \`story\` — **Story** the session serves, found-or-created by name under the project; only if evident. A story bound for Cockpit needs a brief on the story page itself: it becomes the ticket's objective, and the filer skips a story without one.
